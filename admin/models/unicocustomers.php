...
class wizardModelUnicocustomers extends JModelList {

    //Add this handy array with database fields to search in
    protected $searchInFields = array( 'codice', 'ragione_sociale', 'partita_iva');

//Override construct to allow filtering and ordering on our fields
    public function __construct($config = array()) {
//        $config['filter_fields'] = array_merge($this->searchInFields, array('u.codice'));
//        $config['filter_fields'] = array_merge($this->searchInFields, array('u.ragione_sociale'));
//        $config['filter_fields'] = array_merge($this->searchInFields, array('u.partita_iva'));
